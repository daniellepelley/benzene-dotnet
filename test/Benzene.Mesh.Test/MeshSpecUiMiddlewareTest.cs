...
public class MeshSpecUiMiddlewareTest
{
    ...
    public async Task HandleAsync_MatchingPath_WritesHtmlResponse(string method)
    {
        ...
        var (requestAdapter, responseAdapter) = CreateAdapters(context, method, "/mesh-spec-ui.html");
        var middleware = new MeshSpecUiMiddleware<FakeHttpContext>(
            "/mesh-spec-ui.html", "manifest.json", requestAdapter.Object, responseAdapter.Object);
        ...
        responseAdapter.Verify(x => x.SetBody(context, MeshSpecUiPage.GetHtml("manifest.json")), Times.Once);
    ...
    {
        var context = new FakeHttpContext();
        var (requestAdapter, responseAdapter) = CreateAdapters(context, "POST", "/mesh-spec-ui.html");
        var middleware = new MeshSpecUiMiddleware<FakeHttpContext>(
            "/mesh-spec-ui.html", "manifest.json", requestAdapter.Object, responseAdapter.Object);
    ...
    [Fact]
    public void Name_IsMeshSpecUi()
    {
        var context = new FakeHttpContext();
        var (requestAdapter, responseAdapter) = CreateAdapters(context, "GET", "/mesh-spec-ui.html");
        var middleware = new MeshSpecUiMiddleware<FakeHttpContext>(
            "/mesh-spec-ui.html", "manifest.json", requestAdapter.Object, responseAdapter.Object);

        Assert.Equal("MeshSpecUi", middleware.Name);
    }
}
