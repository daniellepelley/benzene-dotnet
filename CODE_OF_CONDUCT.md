...
project maintainers via a private report on GitHub (the repository's **Security** tab →
**Report a vulnerability** may be used for confidential contact) or by contacting the maintainer
through their GitHub profile (<https://github.com/daniellepelley>). All complaints will be
