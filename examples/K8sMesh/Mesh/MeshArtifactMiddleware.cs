...
/// <see cref="IMeshArtifactStore"/> (the artifact directory), so the Mesh UI — a static page that
/// fetches <c>manifest.json</c> relatively — has something to load. Mirrors <c>Benzene.Spec.Ui</c>'s
