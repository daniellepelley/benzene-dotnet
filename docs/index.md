...
- **Code Generation**
  ...
  - [Spec Endpoint (OpenAPI / AsyncAPI / Benzene format)](spec.md) — a runtime feature of a Benzene service, not to be confused with the [Benzene Specification](https://github.com/daniellepelley/Benzene/blob/main/docs/specification/README.md) above: this is a `UseSpec` middleware that serves *your* service's own schema
