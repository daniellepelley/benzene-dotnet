> ARCHIVED 2026-08-20: actioned; Phase 1 / Option A shipped (`src/Benzene.Clients.Http` envelope client); the Phase-2 go/no-go question is extracted to `../1.0-release-plan.md` §9.
