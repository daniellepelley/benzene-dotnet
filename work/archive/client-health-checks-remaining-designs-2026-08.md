> ARCHIVED 2026-08-20: actioned; the per-transport rulings are recorded/implemented where decided (e.g. `ServiceBusHealthCheckExtensions`); the unshipped auto-wiring remainder is tracked in `../1.0-release-plan.md` §9.

# Client health checks — designs for the remaining transports

Companion to `work/archive/client-health-checks-design-2026-08.md`. That plan is **implemented** for every transport
...
Follow the Event Hub precedent (`work/archive/client-health-checks-design-2026-08.md` §4, Phase 4): the check does the
