> ARCHIVED 2026-08-20: actioned; executed plan — shipped (see `docs/terraform.md`).

# Terraform EventBridge Rule Generation Plan

## Why

`work/archive/eventbridge-plan-2026-08.md` deferred one piece of the EventBridge integration as future work:
...
7. Docs: EventBridge section in `docs/terraform.md`; new
   ...
   strike the "future work" deferral note in `work/archive/eventbridge-plan-2026-08.md`.
