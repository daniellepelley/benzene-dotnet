> ARCHIVED 2026-08-20: actioned; shipped as `src/Benzene.ResponseEvents` via `response-events-plan-2026-07.md` (archived here).
...
`work/archive/response-events-plan-2026-07.md`, and the F4 docs bug is fixed. `Benzene.Extras/Broadcast`
...
`work/archive/request-response-design-review-2026-07.md` (response serialization machinery — different scope),
