> ARCHIVED 2026-08-20: actioned; Stages 1–2 shipped in `src/Benzene.Schema.OpenApi` `AsyncApi/`; the open F5 reply-channel question is extracted to `../1.0-release-plan.md` §9.
