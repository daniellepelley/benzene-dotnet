> ARCHIVED 2026-08-20: actioned; review's fixes shipped; the transport token-seeding and test-gap remainders are extracted to `../1.0-release-plan.md` §9.
...
>
> **Update — client contract-drift check shipped (see `work/archive/client-health-checks-design-2026-08.md` §7):**
