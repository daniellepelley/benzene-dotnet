> ARCHIVED 2026-08-20: actioned; shipped as `src/Benzene.Mesh.Discovery.Aws` + `deploy/Discovery`.
...
unauthenticated today** (flagged in `work/archive/auth-middleware-design-2026-07.md` §6). A self-discovering mesh that
