> ARCHIVED 2026-08-20: actioned; executed plan — shipped as `src/Benzene.Aws.Lambda.EventBridge` (its CLAUDE.md cites decisions E1–E7).
...
*(Since done — see `work/archive/terraform-eventbridge-rules-plan-2026-08.md`.)*
