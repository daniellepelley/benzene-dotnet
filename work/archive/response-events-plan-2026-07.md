> ARCHIVED 2026-08-20: actioned; executed plan — shipped as `src/Benzene.ResponseEvents` (its CLAUDE.md cites this plan).
...
`work/archive/response-as-event-design-2026-07.md` (2026-07-19) reviewed the transport pipelines' result
