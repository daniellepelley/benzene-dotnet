> ARCHIVED 2026-08-20: actioned; first increment shipped (contract-drift check, `src/Benzene.Clients.HealthChecks`); the unshipped per-transport checks are extracted to `../1.0-release-plan.md` §9.
...
This extends `work/archive/health-checks-1.0-review-2026-08.md` (which already tracks the provider-coverage gaps as
...
- All remaining transports **designed and resolved** in `work/archive/client-health-checks-remaining-designs-2026-08.md`.
