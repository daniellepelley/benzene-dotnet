> ARCHIVED 2026-08-20: actioned; fixes shipped with regression tests (see the sibling `medium-fixes-design-2026-08.md` and `src/Benzene.Clients/CLAUDE.md` citations).
