> ARCHIVED 2026-08-20: actioned; target design largely shipped (see the doc's own 2026-07-14 audit); the deprecate-vs-keep StartUp decision and CLI/spec-retrieval gap are extracted to `../1.0-release-plan.md` §9.
