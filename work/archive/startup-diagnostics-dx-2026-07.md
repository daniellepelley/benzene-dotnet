> ARCHIVED 2026-08-20: actioned; dated (2026-07-29) code-verified assessment — the start-up check machinery it assessed ships in `src` (`StartUpChecks`, per-transport route checks).
