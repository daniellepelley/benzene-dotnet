> ARCHIVED 2026-08-20: actioned; every finding fixed with regression tests (`test/Benzene.Core.Test/Customization/RobustnessFixesTest.cs`, `BenzeneWireNamesOverrideTest.cs`).
