> ARCHIVED 2026-08-20: actioned; `examples/AzureFunctionsMesh` implements the Azure counterpart.

# AzureFunctionsMesh — multi-transport dogfooding plan

## Goal
The Azure counterpart of `work/archive/aws-mesh-multi-transport-plan-2026-08.md`: make the `examples/AzureFunctionsMesh`
