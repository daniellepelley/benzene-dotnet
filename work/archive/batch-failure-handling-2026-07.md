> ARCHIVED 2026-08-20: actioned; per-transport partial-batch containment shipped (SQS batch response; Kinesis via `kinesis-batch-failure-handling-design-2026-07.md`, archived here).
...
implementing the design at `work/archive/kinesis-batch-failure-handling-design-2026-07.md`.
...
and directly reusable for SQS streaming's still-open half of `work/archive/streaming-plan-2026-08.md` Phase 2.
