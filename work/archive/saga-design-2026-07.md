> ARCHIVED 2026-08-20: actioned; shipped as `src/Benzene.Saga` (its CLAUDE.md records the §7 decisions) — this doc's "no code yet" header predates the implementation.
