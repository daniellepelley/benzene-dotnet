> ARCHIVED 2026-08-20: the normative settlement contract now lives in `docs/capability-matrix.md` (failure-result settlement section), which carries the claim directly; this file remains as the migration record.
