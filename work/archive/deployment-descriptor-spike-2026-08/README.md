> ARCHIVED 2026-08-20: spike superseded by the shipped tool `src/Benzene.Descriptor`; the living design record is `../../deployment-descriptor-design.md`.
...
```bash
dotnet run --project work/archive/deployment-descriptor-spike-2026-08
```
