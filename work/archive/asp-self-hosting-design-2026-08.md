> ARCHIVED 2026-08-20: actioned; shipped as `UseAspNet`/`AspNetServerWorker` in `src/Benzene.AspNet.Core`, covered by `test/Benzene.Core.Test/Hosting/UseAspNetWorkerTest.cs`.
