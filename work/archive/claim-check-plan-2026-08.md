> ARCHIVED 2026-08-20: actioned; shipped as `src/Benzene.ClaimCheck` (+ `.Aws.S3`, `.Azure.Blob`), dogfooded in `examples/AwsMesh` (Phase 6).
...
Identical to `work/archive/spec-mesh-tooling-implementation-plan-2026-08.md` §0 — read that section; the short
