...
- **[RESOLVED] #253 (ruling numbering — `DynamoDbOutboxTransaction.CommitAsync` destructively drained
  ...
  (the thrown-write sibling of the existing over-100-items test).
- **[RESOLVED] #254 (ruling numbering — `OutboxDispatcher.DispatchEnvelopeAsync` treated a post-send
