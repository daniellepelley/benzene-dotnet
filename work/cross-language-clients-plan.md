...
**Companion docs:** [`spec-mesh-tooling-implementation-plan.md`](spec-mesh-tooling-implementation-plan.md)
...
- **Benzene** (cross-language spec repo, `/home/user/Benzene`): Phase 1 only. CRITICAL rule from
  ...
  main).
- **benzene-dotnet**: Phase 2. Conventions per `spec-mesh-tooling-implementation-plan.md` §0
...
**This supersedes Amendment C's deferral.** `spec-mesh-tooling-implementation-plan.md`'s 2026-08-12
...
| Amendment C supersession note | benzene-dotnet (`work/spec-mesh-tooling-implementation-plan.md`) | One-line edit in Phase 1's slice or Phase 2's, whichever lands first. |
