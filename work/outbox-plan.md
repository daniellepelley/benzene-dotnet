...
**Project conventions (from `AGENTS.md` + `work/spec-mesh-tooling-implementation-plan.md` §0):**
...
- **House style.** The clients redesign (`work/benzene-clients-redesign-plan.md`) deliberately
...
- **Observability / mesh surface:** outbox depth and oldest-pending-age as
  ...
  tag discipline (`work/spec-mesh-tooling-implementation-plan.md` Phase 7a).
...
- **Symbolic destinations / route catalog interplay:** `work/benzene-outbound-model-plan.md`'s
  ...
  build it here. (Checked against `work/benzene-clients-redesign-plan.md` too: this plan touches no
...
1. **Release posture:** do `Benzene.Outbox*` join the 1.0 API-freeze surface
   (`work/1.0-api-freeze-proposal.md`) on the next release, or ship a cycle as explicitly
